...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        # Unpack variables from the params dictionart
        ...
        # compute the loss: average cross_entropy loss and regularization
        ...
        grads['W1'] = np.dot(X.reshape((N, D)).T, dhidden)
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers + 1):
            ...
            if i == self.num_layers:
                # handle the final layer here that is affine layer only
